...
This tutorial shows you how to use the ZK Stack CLI to run an Elastic Network ecosystem and custom ZK chain locally:
...
- For background on the Elastic Network or ZK chains, read the [ZK chains](https://docs.zksync.io/zk-stack/zk-chains) section in our docs.
...
An Elastic Network ecosystem is, in short, a system to manage multiple ZK chains.
...
::twitter-button{text="I just made my own ZKsync chain"}
