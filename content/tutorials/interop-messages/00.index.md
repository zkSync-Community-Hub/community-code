...
The app will allow users to stake ETH on one chain, and then receive a token reward on another chain.
...
The token contract allows users to mint some tokens if they can verify that they have previously deposited money to one of the approved staking contracts.
The mint function will check to verify the message sent in the staking contract.
...
ike bridging assets and operate with contracts across different chains.
