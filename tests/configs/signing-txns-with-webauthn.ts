...
const frontendPart1Steps: IStepConfig = {
  ...
  'extract-aa-factory-address': {
    ...
    selector: { regex: /(?<=factory address:\s*)0x[a-fA-F0-9]{40}/i },
  },
  'extract-nft-contract-address': {
    ...
    selector: { regex: /(?<=NFT CONTRACT ADDRESS:\s*)0x[a-fA-F0-9]{40}/i },
  },
  'extract-paymaster-contract-address': {
    ...
    selector: { regex: /(?<=PAYMASTER CONTRACT ADDRESS:\s*)0x[a-fA-F0-9]{40}/i },
  },
