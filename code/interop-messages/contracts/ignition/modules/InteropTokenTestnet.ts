...
const LENS_CONTRACT_ADDRESS = '0x';
...
export default buildModule('InteropTokenModule', (m) => {
  const approvedChainIds = [ABSTRACT_CHAIN_ID, LENS_CHAIN_ID, SOPHON_CONTRACT_ADDRESS];
  const approvedStakingContracts = [ABSTRACT_CONTRACT_ADDRESS, LENS_CONTRACT_ADDRESS, SOPHON_CHAIN_ID];
