...
[`zksync-sso` repository](https://github.com/matter-labs/zksync-sso/tree/68bd9b0ee75c05e91aa4ec52567e9b92f445fb13),
and follow the steps in the [README](https://github.com/matter-labs/zksync-sso/tree/68bd9b0ee75c05e91aa4ec52567e9b92f445fb13?tab=readme-ov-file#running-development)
to launch the example demo app and local auth server.
  Note that the SSO repository has since been updated to support EIP-4337 and EVM only, so you must use the old commit linked here.
